...
function GlCanvas() {
    ...
    this.initialize = () => {
        ...
        this.licht.setColorDiffus(1, 0.5, 1);
    ...
    this.drawObject = (object) => {
        ...
        object.rotationOrder.forEach((order, index) => {
            ...
            let axis;
            switch (order) {
                case X: mat4.fromXRotation(mvMatrix, object.orientation.x); break;
                case Y: mat4.fromYRotation(mvMatrix, object.orientation.y); break;
                case Z: mat4.fromZRotation(mvMatrix, object.orientation.z); break;
            }       
        });
       ...
       // this.gl.uniformMatrix4fv(this.gl.getUniformLocation(this.program, "modelMatrix"), false, mvMatrix);
        ...
        this.gl.uniform3fv(this.getUniform('lichtIntensitaetAmbient'), [1.0, 1.0, 1.0]);
