...
function GlCanvas() {
    ...
    this.initialize = () => {
        ...
        this.licht.setColorDiffus(0.7, 0.7, 0.7);
    ...
    this.add = (object) => {
        ...
        if (object.textureSrc.length > 0) {
            ...
            object.normalMap = this.gl.createTexture();
            object.normalMap.image = new Image();
            object.normalMap.image.src = object.normalSrc;
            object.normalMap.image.addEventListener('load', () => {
                this.gl.bindTexture(this.gl.TEXTURE_2D, object.normalMap);
                this.gl.texImage2D(this.gl.TEXTURE_2D, 0, this.gl.RGBA, this.gl.RGBA, this.gl.UNSIGNED_BYTE, object.normalMap.image);
                this.gl.generateMipmap(this.gl.TEXTURE_2D);
                this.gl.bindTexture(this.gl.TEXTURE_2D, null);
                object.normalMap.loaded = true;
            });
    ...
    this.drawObject = (object) => {
       ...
       // mat4.invert(mvMatrix, mvMatrix);
        ...
        var uNormalMatrix = this.gl.getUniformLocation(this.program, "uNormalMatrix2");
        this.gl.uniformMatrix3fv(uNormalMatrix, false, normalMatrix);
